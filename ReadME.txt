...
In this assignment, we were tasked with creating a program that would take a random query point, and find the one nearest negighbour to 
it(given a graph of biconnected points).
